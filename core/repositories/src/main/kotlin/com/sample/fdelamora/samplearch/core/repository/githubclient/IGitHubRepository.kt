...
interface IGitHubRepository {
    suspend fun userDetails(username: String): GitHubUser

    suspend fun searchUsers(keywords: String): List<GitHubUser>

    suspend fun searchUserRepositories(user: GitHubUser): List<GitHubRepo>
}
